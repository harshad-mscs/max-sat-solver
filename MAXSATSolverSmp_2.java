...
/**
 * Class MAXSATSolverSmp_2 is a parallel version of the Incremental
 * Seesaw Search for MAX-SAT program.
 * 
 * <P>
 * Usage: java pj2 MAXSATSolverSmp_2 inputFilePath max-tries 
 ...
 *
 */
public class MAXSATSolverSmp_2  extends Task{
	...
	public void main(final String ar[])throws Exception{
		...
		parallelFor(0, N - 1).exec(new Loop(){
			...
			public void run (int step) throws NumberFormatException, Exception{
	...
	private static void usage(){
		...
		System.err.println ("Usage: java pj2 MAXSATSolverSmp_2 inputFilePath "
